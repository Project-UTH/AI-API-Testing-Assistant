...
- See the `playwright` skill for Playwright setup
...
1. **Playwright MCP** (recommended)
   - See `playwright` skill for installation
   - Provides: Browser automation, screenshots, viewport testing, console monitoring
...
2. Link to appropriate skill for installation (`playwright`)
...
- **playwright**: E2E testing with Playwright, browser automation setup
...
4. Verify browser tools are installed (see `playwright` skill)
