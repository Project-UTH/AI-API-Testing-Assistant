...
function Checkbox({ className, ...props }: CheckboxPrimitive.Root.Props) {
  return (
    <CheckboxPrimitive.Root
      ...
      {...props}
    >
      {/* data-indeterminate ("chọn 1 phần") phải hiện dấu gạch ngang, KHÔNG dùng chung icon dấu tick
          với data-checked ("chọn hết") - nếu không người dùng không phân biệt được 2 trạng thái. */}
