...
/** Số liệu tổng quan trang Tổng quan (Module 8) - đọc-tổng hợp, không phải logic AI/engine thực thi. */
@Service
...
public class DashboardService {
    ...
    public DashboardSummaryResponse getSummary() {
        ...
        return new DashboardSummaryResponse(
                totalProjects, totalEndpoints, totalTestCases, totalTestResults, overallPassRate);
    }
}
